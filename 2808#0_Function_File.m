...
function jacobian_matrices = find_jacobian_matrices(x_1, x_2, x1_dot, x2_dot)
  ...
  jacobian_matrices = {};
  ################## ADD YOUR CODE HERE ######################
  jacobian_matrices =jacobian([x1_dot,x2_dot],[x1,x2]);
  #size(matrices );
  jacobian_matrices ={double(subs(jacobian_matrices,{x1,x2},solutions(1,:))),double(subs(jacobian_matrices,{x1,x2},solutions(2,:))),double(subs(jacobian_matrices,{x1,x2},solutions(3,:)))};
